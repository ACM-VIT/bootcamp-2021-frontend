...
const Perks = () => (
  <div className="text-left xs:float-right">
    ...
    <div className="flex-col mr-10">
      <div className="flex xs:flex-row-reverse mt-16 ml-32">
      ...
      <div className="flex xs:flex-row-reverse mt-8">
        <img className="mr-28" src={Dot} alt="dot" />
        <p className="font-poppins font-semibold mr-4 text-2xl text-black">
      ...
      <div className="flex xs:flex-row-reverse mt-8 ml-8">
        <img className="mr-28" src={Dot} alt="dot" />
        <p className="font-poppins font-semibold mr-4 text-2xl text-black">
      ...
      <div className="flex xs:flex-row-reverse mt-8 ml-20">
        <img className="mr-28" src={Dot} alt="dot" />
        <p className="font-poppins font-semibold mr-4 text-2xl text-black">
