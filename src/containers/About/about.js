...
const About = () => (
  <div id="about">
    <h1 className="flex text-left pl-6 sm:justify-center xs:mr-10 font-poppins font-bold mt-20 sm:mt-24 text-3xl sm:text-4xl md:text-5xl text-gray-900 text-opacity-90 tracking-tight">
      About Bootcamp
    </h1>
    ...
    <h2 className="text-left sm:justify-center sm:text-center font-poppins font-semibold mt-8 sm:mt-12 px-6 text-lg sm:text-2xl md:text-3xl text-yellow-500 text-opacity-100">
