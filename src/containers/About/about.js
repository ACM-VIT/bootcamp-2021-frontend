...
const About = () => (
  <div>
    <h1 className="flex justify-center font-poppins font-bold mt-32 text-5xl text-gray-900 text-opacity-90 tracking-tight">
      About Bootcamp
    </h1>
    ...
    <p className="flex justify-center font-poppins font-semibold mt-12 text-xl text-black">
      Within two weeks, you will have gained diverse technical knowledge and
      also have incredible projects under your belt.
    </p>

    <p className="justify-center font-poppins font-semibold mx-40 mt-8 text-xl text-black">
